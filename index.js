...
if (level === 2) backgroundImage = './img/background.jpg'
if (level === 3) backgroundImage = './img/background.jpg'
...
function goHome() {
  window.location.href = 'home.html' // ya apna home page path
}
